...
public:
	...
	int build_tree(const int Nx, const int Ny, const int Nz, int terminal_pts, int tree_number, float scale, unsigned int seed, float outResolutionScaleFactor, string phantomPath, string outputPath);//builds vessel tree
